...
namespace _02.DoublePalindromes                                                                                                                                                                  
{                                                                                                                                                                                                
    public class DoublePalindromes                                                                                                                                                               
    {                                                                                                                                                                                            
        public static void Main()
        {
            string copiedNumbers =
                "                1   1 0     0                                                                                                                                                                   " +
                "  2   1 1     1                                                                                                                                                                                 " +
                "  3   2 11     3                                                                                                                                                                                " +
                "  4   3 101     5                                                                                                                                                                               " +
            ...
            string[] palindromes = copiedNumbers.Split(new[] {' '}, StringSplitOptions.RemoveEmptyEntries);
            for (int i = 3; i < palindromes.Length; i += 4)
            {
                Console.Write(i < palindromes.Length - 1 ? palindromes[i] + ", " : palindromes[i] + "\n");
            }
        }
    }
}
